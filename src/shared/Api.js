...
export const AuthApi = {
    ...
    // 동화 작성 조회
    postStories: (payload) => api.post('/stories', payload),
    ...
    // 작성중 여부 체크
    isWritingCheak: (payload) => api.post('/stories/:storyId/relay/isWriting', payload),
    // 문장 세부 정보 
    ...
    likeRelay: (payload) => api.put('/stories/:storyId/relay/relayId/like', payload)
}
